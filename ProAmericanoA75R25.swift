...
//saat ini
struct ProAmericanoA75R25: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProAmericanoA75R25: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Americano with 75% Arabica and 25% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isHotWaterComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endamericanoa75r25
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProAmericanoA75R25
    ...
    func addButtonAmericanoA75R25GoTo1() -> some View {
