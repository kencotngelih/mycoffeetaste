...
//saat ini
struct ProMacchiatoA25R75: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProMacchiatoA25R75: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Macchiato with 25% Arabica and 75% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endmacchiatoa25r75
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProMacchiatoA25R75
    ...
    func addButtonMacchiatoA25R75GoTo1() -> some View {
