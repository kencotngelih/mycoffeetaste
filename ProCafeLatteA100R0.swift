...
//saat ini
struct ProCafeLatteA100R0: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProCafeLatteA100R0: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Cafe Latte with 100% Arabica")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endcafelattea100r0
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProCafeLatteA100R0
    ...
    func addButtonCafeLatteA100R0GoTo1() -> some View {
