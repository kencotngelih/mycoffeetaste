...
//saat ini
struct EspA25R75: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorEspA25R75: Color = Color("lightgray")
    ...
    var stepInformation: some View {
        Group {
            ...
            if ( counter == 0 ) {
                Text("To create 1 shot Espresso (30ml). We need 20 grams of coffee powder and 60ml hot water (90 degree Celcius). Why 20 grams ? Because there is a rule among coffee makers: ratio between coffee powder and output espresso is 1:1.5 . Then in this Espresso, we need 5 grams of Arabica dan 15 grams of Robusta.\n\nWe also need some equipment, for example : A Rokpresso and a Portafilter (to extract coffee powder become Espresso), Scales (to make sure the quantities are correct), Spoons (to add coffee power to portafilter), and an Espresso Glass (to keep the espresso).")
                    .font(.body)
                    .bold()
                    ...
                    Text("Step 1:\nAdd 5 grams of Arabica to Portafilter.")
                        .font(.body)
                        .bold()
                        .foregroundColor(Color("white"))
                        .multilineTextAlignment(.center)
                ...
                Text("Step 2\nAdd 15 grams of Robusta to Portafilter.")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("white"))
                    .multilineTextAlignment(.center)
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Espresso with 25% Arabica and 75% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .addona25r75
                            }, label: {
