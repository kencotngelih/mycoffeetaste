...
//saat ini
struct EspA50R50: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorEspA50R50: Color = Color("lightgray")
    ...
    var stepInformation: some View {
        Group {
            ...
            if ( counter == 0 ) {
                Text("To create 1 shot Espresso (30ml). We need 20 grams of coffee powder and 60ml hot water (90 degree Celcius). Why 20 grams ? Because there is a rule among coffee makers: ratio between coffee powder and output espresso is 1:1.5 . Then in this Espresso, we need 10 grams of Arabica dan 10 grams of Robusta.\n\nWe also need some equipment, for example : A Rokpresso and a Portafilter (to extract coffee powder become Espresso), Scales (to make sure the quantities are correct), Spoons (to add coffee power to portafilter), and an Espresso Glass (to keep the espresso).")
                    .font(.body)
                    .bold()
                    ...
                    .padding(.trailing, 75)
                    .padding(.bottom, 25)
                    addButtonEspA50R50GoTo1()
            } else if ( counter == 1) {
                    Text("Step 1:\nAdd 10 grams of Arabica to Portafilter.")
                        .font(.body)
                        .bold()
                        .foregroundColor(Color("white"))
                        .multilineTextAlignment(.center)
                ...
                Text("Step 2\nAdd 10 grams of Robusta to Portafilter.")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("white"))
                    .multilineTextAlignment(.center)
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Espresso with 50% Arabica and 50% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    Spacer()
                    VStack{
                        Image("resizeCoffeeSpoon2x")
                            .resizable()
                            .scaledToFill()
                            .frame(width: 200, height: 200)
                        Text("2 x 5 grams Arabica")
                            .font(.body)
                            .bold()
                            .foregroundColor(Color("black"))
                            .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .addona50r50
                            }, label: {
    ...
    func addButtonEspA50R50GoTo1() -> some View {
    ...
    func addButtonEspA50R50GoTo2() -> some View {
        return Button(action: {
            self.counter += 1
        }, label: {
            Text("Add")
    ...
    func addButtonEspA50R50GoTo3() -> some View {
        return Button(action: {
            self.counter += 0
        }, label: {
            Text("")
