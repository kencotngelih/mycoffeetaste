...
//saat ini
struct ProCafeLatteA75R25: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProCafeLatteA75R25: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Cafe Latte with 75% Arabica and 25% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endcafelattea75r25
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProCafeLatteA75R25
    ...
    func addButtonCafeLatteA75R25GoTo1() -> some View {
