...
//saat ini
struct ProCappuccinoA100R0: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProCappuccinoA100R0: Color = Color("lightgray")
        ...
        Group {
            ...
            if ( counter == 0 ) {
                Text("To create a cappuccino, you will need three ingredients : espresso, steam milk, and foam milk. In cappuccino, the ratio among them is equal. 1/3 of Espresso, 1/3 of Steam Milk, and 1/3 of Foam Milk.\n\nFor the equipment, we need an empty glass for serving.")
                    ...
                    .padding(.trailing, 75)
                    .padding(.bottom, 25)
                    addButtonCappuccinoA100R0GoTo1()
            } else if ( counter == 1) {
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Cappuccino with 100% Arabica")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endcappuccinoa100r0
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProCappuccinoA100R0
    ...
    func addButtonCappuccinoA100R0GoTo1() -> some View {
