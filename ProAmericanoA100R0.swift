...
//saat ini
struct ProAmericanoA100R0: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProAmericanoA100R0: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Americano with 100% Arabica")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isHotWaterComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endamericanoa100r0
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProAmericanoA100R0
    ...
    func addButtonAmericanoA100R0GoTo1() -> some View {
