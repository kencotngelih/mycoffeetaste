...
//saat ini
struct ProCafeLatteA25R75: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProCafeLatteA25R75: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Cafe Latte with 25% Arabica and 75% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endcafelattea25r75
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProCafeLatteA25R75
    ...
    func addButtonCafeLatteA25R75GoTo1() -> some View {
