...
//saat ini
struct ProCappuccinoA50R50: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProCappuccinoA50R50: Color = Color("lightgray")
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endcappuccinoa50r50
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProCappuccinoA50R50
    ...
    func addButtonCappuccinoA50R50GoTo1() -> some View {
