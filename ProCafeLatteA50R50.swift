...
//saat ini
struct ProCafeLatteA50R50: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProCafeLatteA50R50: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Cafe Latte with 50% Arabica and 50% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endcafelattea50r50
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProCafeLatteA50R50
    ...
    func addButtonCafeLatteA50R50GoTo1() -> some View {
