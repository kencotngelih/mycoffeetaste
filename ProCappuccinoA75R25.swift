...
//saat ini
struct ProCappuccinoA75R25: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProCappuccinoA75R25: Color = Color("lightgray")
        ...
        Group {
            ...
            if ( counter == 0 ) {
                Text("To create a cappuccino, you will need three ingredients : espresso, steam milk, and foam milk. In cappuccino, the ratio among them is equal. 1/3 of Espresso, 1/3 of Steam Milk, and 1/3 of Foam Milk.\n\nFor the equipment, we need an empty glass for serving.")
                    ...
                    .padding(.trailing, 75)
                    .padding(.bottom, 25)
                    addButtonCappuccinoA75R25GoTo1()
            } else if ( counter == 1) {
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Cappuccino with 50% Arabica and 50% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            //addButtonCappuccinoA50R50GoTo1()
                            
                            Button(action: {
                                viewRouter.currentView = .endcappuccinoa75r25
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProCappuccinoA75R25
    ...
    func addButtonCappuccinoA75R25GoTo1() -> some View {
