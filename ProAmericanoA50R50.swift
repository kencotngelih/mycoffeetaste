...
//saat ini
struct ProAmericanoA50R50: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProAmericanoA50R50: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Americano with 50% Arabica and 50% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isHotWaterComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endamericanoa50r50
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProAmericanoA50R50
    ...
    func addButtonAmericanoA50R50GoTo1() -> some View {
