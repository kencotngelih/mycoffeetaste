...
//saat ini
struct ProMacchiatoA100R0: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProMacchiatoA100R0: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Macchiato with 100% Arabica")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endmacchiatoa100r0
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProMacchiatoA100R0
    ...
    func addButtonMacchiatoA100R0GoTo1() -> some View {
