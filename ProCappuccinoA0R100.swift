...
//saat ini
struct ProCappuccinoA0R100: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProCappuccinoA0R100: Color = Color("lightgray")
        ...
        Group {
            ...
            if ( counter == 0 ) {
                Text("To create a cappuccino, you will need three ingredients : espresso, steam milk, and foam milk. In cappuccino, the ratio among them is equal. 1/3 of Espresso, 1/3 of Steam Milk, and 1/3 of Foam Milk.\n\nFor the equipment, we need an empty glass for serving.")
                    ...
                    .padding(.trailing, 75)
                    .padding(.bottom, 25)
                    addButtonCappuccinoA0R100GoTo1()
            } else if ( counter == 1) {
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Cappuccino with 100% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endcappuccinoa0r100
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProCappuccinoA0R100
    ...
    func addButtonCappuccinoA0R100GoTo1() -> some View {
