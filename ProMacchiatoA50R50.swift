...
//saat ini
struct ProMacchiatoA50R50: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProMacchiatoA50R50: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Macchiato with 50% Arabica and 50% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endmacchiatoa50r50
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProMacchiatoA50R50
    ...
    func addButtonMacchiatoA50R50GoTo1() -> some View {
