...
struct AddOnA100R0: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack {
                    ...
                    Text("Well Done !!!\nYour Basic Espresso with 100% Arabica is Ready.\nNow, Let's Move On to The Next Step.")
                        .font(.title)
                        .bold()
                ...
                //target ke
                Button(action: {
                    viewRouter.currentView = .proamericanoa100r0
                }, label: {
                ...
                Button(action: {
                    viewRouter.currentView = .procafelattea100r0
                }, label: {
                ...
                Button(action: {
                    viewRouter.currentView = .procappuccinoa100r0
                }, label: {
                ...
                Button(action: {
                    viewRouter.currentView = .promacchiatoa100r0
                }, label: {
        ...
        .onAppear{ SoundManager.instance.playSound(sound: .soundaddona100r0) }
    }
}
