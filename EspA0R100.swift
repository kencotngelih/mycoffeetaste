...
//saat ini
struct EspA0R100: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorEspA0R100: Color = Color("lightgray")
    ...
    var stepInformation: some View {
        Group {
            ...
            if ( counter == 1 ) {
                Text("To create 1 shot Espresso (30ml). We need 20 grams of coffee powder and 60ml hot water (90 degree Celcius). Why 20 grams ? Because there is a rule among coffee makers: ratio between coffee powder and output espresso is 1:1.5 . Then in this Espresso, we need 20 grams of Robusta.\n\nWe also need some equipment, for example : A Rokpresso and a Portafilter (to extract coffee powder become Espresso), Scales (to make sure the quantities are correct), Spoons (to add coffee power to portafilter), and an Espresso Glass (to keep the espresso).")
                    .font(.body)
                    .bold()
                    ...
                    .padding(.trailing, 75)
                    .padding(.bottom, 25)
                    addButtonEspA0R100GoTo1()
            }
            else if ( counter == 2) {
                Text("Step 1\nAdd 20 grams of Robusta to Portafilter.")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("white"))
                    .multilineTextAlignment(.center)
    ...
    var componentStep1: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Espresso with 100% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .addona0r100
                            }, label: {
    ...
    func addButtonEspA0R100GoTo1() -> some View {
    ...
    func addButtonEspA0R100GoTo2() -> some View {
        return Button(action: {
            self.counter += 1
        }, label: {
            Text("Add")
