...
//saat ini
struct ProAmericanoA25R75: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProAmericanoA25R75: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            ...
            VStack {
                ...
                Text("Ingredients for making Americano with 25% Arabica and 75% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isHotWaterComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endamericanoa25r75
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProAmericanoA25R75
    ...
    func addButtonAmericanoA25R75GoTo1() -> some View {
