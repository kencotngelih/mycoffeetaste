...
//saat ini
struct ProMacchiatoA75R25: View {
    @EnvironmentObject private var viewRouter: ViewRouter
    
    @State var backgroundColorProMacchiatoA75R25: Color = Color("lightgray")
    ...
    var componentStep0: some View {
        Group {
            VStack {
                ...
                Text("Ingredients for making Macchiato with 75% Arabica and 25% Robusta")
                    .font(.body)
                    .bold()
                    .foregroundColor(Color("black"))
                    .multilineTextAlignment(.center)
                ...
                HStack {
                    VStack {
                        ...
                        if (isFoamMilkComplete == true) {
                            ...
                            Button(action: {
                                viewRouter.currentView = .endmacchiatoa75r25
                            }, label: {
    ...
    var body: some View {
        ...
        ZStack {
            backgroundColorProMacchiatoA75R25
    ...
    func addButtonMacchiatoA75R25GoTo1() -> some View {
